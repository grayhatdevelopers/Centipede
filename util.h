...
#define FPS 20 // frame per seconds
...
void DrawString2(int x, int y, const string& str, float * color = NULL);
void DrawString3(int x, int y, int points, float * color = NULL);
void DrawString4(int x, int y, const string& str, float * color = NULL);
